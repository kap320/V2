    ...
    <div>
      <div className='w-[90vw] flex justify-between mt-[0.5rem] md:mt-[1rem]'>
        ...
        <div className='relative'>
          ...
          }} value={search} onChange={(e) => setSearch(e.target.value)} type='text' autoComplete="new-password" placeholder='Search a anime' className={`${poppinsMedium.className} pr-[2.5rem] max-w-[300px] tracking-wider text-white !outline-none px-[1rem] h-[2.5rem] border-none  rounded-2xl`} />
