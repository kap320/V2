...
const Play = ({epi,animeId})=>{
  ...
  return (
    <div onClick={handleGoto} className={`w-[200px] bg-[#a83535] hover:scale-[1.15] flex items-center justify-center cursor-pointer transition-all duration-300  border-white border-[2px] scale-110 h-[120px]  rounded-[20px]`}>
